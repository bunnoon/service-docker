"""
Django settings for bunnoon project.
...
SECRET_KEY = 'django-insecure-xi=bue5hiba5%$hu+#dg7f^4)l=d6ui%h-#*how2eu_-3sm0#-'
...
WSGI_APPLICATION = 'bunnoon.wsgi.application'
